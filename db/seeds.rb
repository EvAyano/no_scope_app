...
words = Word.create([
  ...
  { term: "Callout", definition: "マップ上の特定の場所を指す用語", explanation: "Aショートやロング、ヘブンなどマップ上に書いてあるそれぞれの場所の名前のこと", game_name: "general" },
  ...
  { term: "Cubby", definition: "小さな隠れ場所", explanation: "ヘイブンのCロングにある窪みなど", game_name: "general" },
  ...
  { term: "OP", definition: "オペレーター、強力なスナイパーライフル。あるいは非常に強いこと。", explanation: "Operatorという武器の略。「非常に強いこと」を意味する場合はOver Poweredの略", game_name: "general" },
  ...
  { term: "Ult", definition: "アルティメットアビリティの略", explanation: "日本語ではウルトと発音するが、実際の発音はアルト寄り", game_name: "general" },
  { term: "TP", definition: "テレポートの略", explanation: "バインドにあるテレポーターのこと", game_name: "general" },
  { term: "Wallbang", definition: "壁を通して敵を撃つこと", explanation: "アセントBメインで守り側のソーヴァがよくオーディンを持ってやっていますね", game_name: "general" }
])
